...
# -*- coding: utf-8 -*-
#
# cookiecutter-pylib documentation build configuration file, created by
...
copyright = '%d, {{ cookiecutter.full_name.replace('\"', '\\\"') }}' % year
author = 'Spokane Minnig Research Division'
...
latex_documents = [
  (master_doc, 'pylib.tex', '{{ cookiecutter.project_slug }} Documentation',
   'Spokane Mining Research Division', 'manual'),
]
